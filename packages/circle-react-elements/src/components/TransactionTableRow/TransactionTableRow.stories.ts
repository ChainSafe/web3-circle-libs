...
export const WithActions: Story = {
  args: {
    transaction: {
      ...
      amounts: ['30'],
      nfts: undefined,
      txHash: '0xf564a9aab61208eb275112e05dfa5514d7fdc66b1424b1c138472912172846e9',
      blockHash: '0x3bd9054deae68d0d5087da188f119eab2160c12c8a255668e6190c60ffed9ff6',
      blockHeight: 15439404,
      networkFee: '0.005164650002582325',
      firstConfirmDate: '2024-12-10T13:52:57Z',
...
export const WithActionsAndDetails: Story = {
  args: {
    transaction: {
      id: 'c0d471be-f36f-5e26-8962-9ebd38ec8a62',
      blockchain: 'ETH',
    ...
    withActions: true,
    onClickDetails: (tx) => {
      alert(`Details clicked: ${JSON.stringify(tx)}`);
    },
  },
};
