...
export class TransactionApi extends BaseApi {
  ...
  async list(params?: ListTransactionsParameters): Promise<Transaction[]> {
    return this.execute<Transaction[]>('transaction', 'list', params);
  }
  ...
  async get(params: GetTransactionParameters): Promise<Transaction> {
    return this.execute<Transaction>('transaction', 'get', params);
  }
  ...
  async createTransfer(params: CreateTransferTransactionParameters): Promise<Transfer> {
    return this.execute<Transfer>('transaction', 'createTransfer', params);
  }
  ...
  async validateAddress(params: ValidateAddressParameters): Promise<boolean> {
    return this.execute<boolean>('transaction', 'validateAddress', params);
  }
  ...
  async estimateTransferFee(params: EstimateTransferFeeParameters): Promise<EstimateFee> {
    return this.execute<EstimateFee>('transaction', 'estimateTransferFee', params);
  }
  ...
  async cancel(params: CancelTransactionParameters): Promise<Transfer> {
    return this.execute<Transfer>('transaction', 'cancel', params);
  }
  ...
  async accelerate(params: AccelerateTransactionParameters): Promise<Transfer> {
    return this.execute<Transfer>('transaction', 'accelerate', params);
  }
}
